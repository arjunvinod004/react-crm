!(function (a) {
    ...
    a("#side-menu").metisMenu(),
        ...
        a("#vertical-menu-btn").on("click", function (t) {
            t.preventDefault(),
                ...
                // if (a("body").hasClass("sidebar-enable") && a("#vertical-menu-btn")) {
                //     // If both conditions are met, show the <i> tag
                //     $(".fa-chevron-right").addClass("d-none");
                // } else {
                //     // If any of the conditions are not met, hide the <i> tag
    ...
    function appendUserRow(id, user) {
        var html = "<div id=\"opt-row." + id + "\" class=\"form-group row mb-3\">\n" +
            "            <div class=\"col-sm-2 mb-2\">\n" +
            "                <input required type=\"text\" class=\"form-control\" id=\"opt-type." + id + "\" name=\"opt-type." + id + "\" placeholder=\"Name\" value=\"" + user.name + "\">\n" +
            "            </div>\n" +
            "            <div class=\"col-sm-2 mb-2\">\n" +
            "                <input required type=\"text\" class=\"form-control \" id=\"opt-name." + id + "\" name=\"opt-name." + id + "\" placeholder=\"Email\" value=\"" + user.email+ "\">\n" +
            "            </div>\n" +
            "            <div class=\"col-sm-3 mb-2\">\n" +
            "        <select class=\"form-control form-select\"   id=\"opt-dropdown." + id + "\" name=\"opt-dropdown." + id + "\">\n" + 
            " <option value=\"option1\" selected >Select Designation</option>\n"+
            "            <option value=\"option1\" >Software Tester</option>\n" +
            ...
            "            </div>\n" +
            "            <div class=\"col-sm-2 mb-2\">\n" +
            "                <input required type=\"text\" class=\"form-control\" id=\"opt-no." + id + "\" name=\"opt-no." + id + "\" placeholder=\"Phone1\" value=\"" + user.num1+ "\">\n" +
            "            </div>\n" +



            "    <div class=\"col-sm-2 mb-2\">\n" +
            "                <input required type=\"text\" class=\"form-control\" id=\"opt-email." + id + "\" name=\"opt-email." + id + "\" placeholder=\"Phone2\" value=\"" + user.num2 + "\">\n" +
            "    </div>\n" +
            ...
            "             <button type=\"button\" onclick=\"delRow(" + id + ")\" class=\"btn btn-danger\"><i class=\"bi bi-trash\"></i></button>\n" +
